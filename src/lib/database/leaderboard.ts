  ...
  static async submitScore(context: SimulationContext, userId: string, username: string): Promise<LeaderboardEntry | null> {
    try {
      ...
      const leaderboardEntry: Partial<LeaderboardEntry> = {
        ...
        company_size: context.strategy.companySize || null,
        market_landscape: context.strategy.marketLandscape || null,
        time_horizon: context.strategy.timeHorizon || null,
        budget_allocation: context.strategy.budgetAllocation || null,
